...
class SymbolInner extends Component {
  ...
  render() {
    ...
    return (
      <div className="wrap max-w-full flex flex-row flex-nowrap gap-x-12 relative items-start bg-slate-800">
        ...
        { (this.props.states.sections[this.props.states.currentSection] !== undefined) ?
          <div className="canvases w-full h-full flex flex-row flex-wrap relative pl-24 pr-24 pb-24 justify-center">
            {/* <NewCanvas
              ...
              origin={this.props.states.origin}
              residence={this.props.states.residence}
              livingdata={this.props.states.sections[0].questionValues}
              sections={this.props.states.sections}
              questionvalues={this.props.states.sections[this.props.states.currentSection].questionValues}
              width="100%"
              height="auto"
              stitch='x' /> */}
            <div className="canvasesInner w-1/2 ">
              <HomeCanvas
                  ...
                  data={this.props.states.sections[0] !== undefined ? this.props.states.sections[0].questionValues : [0,0,0,0,0,0,0] }
                  sections={this.props.states.sections}
                  questionvalues={this.props.states.sections[this.props.states.currentSection].questionValues}
                  width="100%"
                  height="auto"
              ...
              <WorkCanvas
                ...
                residence={this.props.states.residence}
                colors={this.palettes}
                data={this.props.states.sections[1] !== undefined ? this.props.states.sections[1].questionValues : [0,0,0,0,0,0,0] }
                sections={this.props.states.sections}
                width="100%"
                height="auto"
                stitch='x' />
              <PartnerCanvas
                ...
                residence={this.props.states.residence}
                colors={this.palettes}
                data={this.props.states.sections[2] !== undefined ? this.props.states.sections[2].questionValues : [1,0,0,0,0,0,0] }
                sections={this.props.states.sections}
                width="100%"
                height="auto"
                stitch='x' />
          ...
          <div className="absolute left-0 top-8 flex flex-row items-center flex-nowrap border border-gray-200 rounded-xl ml-8 pl-4 py-4 bg-gray-200">
            <button className='text-3xl' onClick={() => this.props.backToInterface()}>Start over</button>
