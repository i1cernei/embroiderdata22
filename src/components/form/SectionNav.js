  ...
  render() {
    return (
      <div className='w-full flex flex-row justify-between px-8 mt-4 ml-4'>
        ...
        <div className="next flex flex-row-reverse items-center flex-nowrap border border-gray-200 rounded-xl pl-4 py-4">
        ...
        {this.props.currentQuestion === this.props.sections[this.props.currentSection].questionValues.length - 1 ?
          <div className="next flex flex-row items-center flex-nowrap border border-gray-200 rounded-xl pl-4 py-4">
